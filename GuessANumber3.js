...
var randomNumberGenerated = 0;						// initialize counter
...
app.post('/startGame', function(req,res){
  ...
  randomNumber[req.body.gameId] = randomNumberGenerated;
	responseMessage = { APIMessage:'Game number ' + req.body.gameId + ' started' };
  ...
  app.get('/guessMade', function(req,res){
    ...
    var numberGuessed = parseInt(req.query.guessMade);
    var guessed = false;
    ...
    responseMessage = { APIMessage: outMessage, Guessed: guessed, numberToGuess: numberToGuess };
    res.json(responseMessage);
  })
